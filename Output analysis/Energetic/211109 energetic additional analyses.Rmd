---
title: "211109 energetic additional analyses"
author: "Anne Margit"
date: "11/05/2021"
...
> Effect sizes for intercept and main effect of age and covariates = regression coefficient / average ISD of Energetic
> Effect size for main effect of DaysMax = (regression coefficient * 28)/ average ISD of Energetic
> Effect sizes for interaction effects = (regression coefficient * 28)/ average ISD of Energetic
> The effect sizes for main effect of DaysMax and the interaction effects reflect the increase in SD of Energetic over 4 weeks (28 days)
...
*Effect sizes*
**Within person SD and average within person SD for Energetic**
```{r, message=F, comment=NA}
...
> Effect sizes for intercept and main effect of age = regression coefficient / average ISD of Energetic
> Effect size for main effect of DaysMax = (regression coefficient * 28)/ average ISD of Energetic
> Effect sizes for interaction effects = (regression coefficient * 28)/ average ISD of Energetic
> The effect sizes for main effect of DaysMax and the interaction effects reflect the increase in SD of Energetic over 4 weeks (28 days)
